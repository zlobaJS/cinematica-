...
const sortbyData = [
    ...
    { value: "vote_average.asc", label: "По рейтингу (возрастание)" },
    {
        ...
        label: "Дата выпуска (убывание)",
    },
    { value: "primary_release_date.asc", label: "Дата выпуска (возрастание)" },
    { value: "original_title.asc", label: "Заголовок (А-Я)" },
];
                    ...
                    <>
                        { data?.results?.length > 0 ? (
                            ...
                            <span className="resultNotFound">
                               Извините, не найдены результаты!
                            </span>
                        )}
                    </>
                )}
